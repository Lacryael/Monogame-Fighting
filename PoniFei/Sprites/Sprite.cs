...
namespace PoniFei.Sprites
{
    public class Sprite : Component, ICloneable
    {
        ...
        public Rectangle RectangleQ
        {
            get
            {
                return new Rectangle((int)Position.X, (int)Position.Y, 230, 600);
            }
        }
        ...
        {
            return this.RectangleQ.Right + Velocity.X > sprite.RectangleQ.Left &&
              this.RectangleQ.Left < sprite.RectangleQ.Left &&
              this.RectangleQ.Bottom > sprite.RectangleQ.Top &&
              this.RectangleQ.Top < sprite.RectangleQ.Bottom;
        }

        protected bool IsTouchingRight(Sprite sprite)
        {
            return this.RectangleQ.Left + Velocity.X < sprite.RectangleQ.Right &&
              this.RectangleQ.Right > sprite.RectangleQ.Right &&
              this.RectangleQ.Bottom > sprite.RectangleQ.Top &&
              this.RectangleQ.Top < sprite.RectangleQ.Bottom;
        }
        ...
        {
            return this.RectangleQ.Bottom + Velocity.Y > sprite.RectangleQ.Top &&
              this.RectangleQ.Top < sprite.RectangleQ.Top &&
              this.RectangleQ.Right > sprite.RectangleQ.Left &&
              this.RectangleQ.Left < sprite.RectangleQ.Right;
        }

        protected bool IsTouchingBottom(Sprite sprite)
        {
            return this.RectangleQ.Top + Velocity.Y < sprite.RectangleQ.Bottom &&
              this.RectangleQ.Bottom > sprite.RectangleQ.Bottom &&
              this.RectangleQ.Right > sprite.RectangleQ.Left &&
              this.RectangleQ.Left < sprite.Rectangle.Right;
        }
