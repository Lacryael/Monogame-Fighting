...
namespace PoniFei.States
{
    public class UpravState : State
    {
        ...
        public UpravState(Game1 game, GraphicsDevice graphicsDevice, ContentManager content)
              : base(game, graphicsDevice, content)
        {
            var BackgroundTexture = _content.Load<Texture2D>("Background/BackgroundUP");
            ...
            var ult = new Button(buttonTexture6, buttonFont1)
            {
                Position = new Vector2(625, 885),
                Text = "Особые способности",
            };

            ult.Click += UltButton_Click;
            ...
            _components = new List<Component>()
      {
        ...
        private void UltButton_Click(object sender, EventArgs e)
        {
            _game.ChangeState(new Ult (_game, _graphicsDevice, _content));
