...
namespace PoniFei.States
{
    public class PvpState : State
    {
        ...
        public PvpState(Game1 game, GraphicsDevice graphicsDevice, ContentManager content)
          : base(game, graphicsDevice, content)
        {
            ...
            var Mana2 = _content.Load<Texture2D>("Controls/Mana2");
            var Mana12 = new Mana2(Mana2)
            {
                Position = new Vector2(1234, 130),
            };
            ...
            var Hp0 = _content.Load<Texture2D>("Controls/Hp22");
                ...
                _components = new List<Component>()
      {
            ...
            var pauseeW = _content.Load<Texture2D>("Controls/pauseW1");
            ...
            var pauseeL = _content.Load<Texture2D>("Controls/pauseL2");
            ...
            _components3 = new List<Component>()
      {
        ...
        public override void LoadContent()
        {
...

            {
                ...
                var rar = new Player(new Dictionary<string, Animation>()
              {
                ...
                var rainbow2 = new Player2(new Dictionary<string, Animation>()
                     {
                           ...
                           { "Dead", new Animation(_content.Load<Texture2D>("Heroes/Rainbow/Dead"), 1) },
                           { "Suicide", new Animation(_content.Load<Texture2D>("Heroes/Rainbow/Suicide"), 4) { FrameSpeed = 1f, }},
                           { "ULTA", new Animation(_content.Load<Texture2D>("Heroes/Rainbow/ULTAL"), 6) },
                     })
                {
                    ...
                    Input = new Input()
                    {
                        ...
                        Udar = Keys.NumPad9,
                        Blok = Keys.NumPad5,
                        Suicide = Keys.NumPad1,
                        ULTA = Keys.NumPad3,
                    },
                    Health = 100,

                };
                var pinki2 = new Player2(new Dictionary<string, Animation>()
                     {
                           ...
                           { "Dead", new Animation(_content.Load<Texture2D>("Heroes/Pinki/Dead"), 1) },
                           { "Suicide", new Animation(_content.Load<Texture2D>("Heroes/Pinki/Suicide"), 4) { FrameSpeed = 1f, }},
                           { "ULTA", new Animation(_content.Load<Texture2D>("Heroes/Pinki/ULTAL"), 1) },
                     })
                {
                    Position = new Vector2(1600, 610),
                    Bullet = bulletPrefab,
                ...
                var apple2 = new Player2(new Dictionary<string, Animation>()
                     {
                           ...
                           { "Dead", new Animation(_content.Load<Texture2D>("Heroes/Apple/Dead"), 1) },
                           { "Suicide", new Animation(_content.Load<Texture2D>("Heroes/Apple/Suicide"), 4) { FrameSpeed = 1f, }},
                           { "ULTA", new Animation(_content.Load<Texture2D>("Heroes/Apple/ULTAL"), 1) },
                     })
                {
                    Position = new Vector2(1600, 610),
                    Bullet = bulletPrefab,
                ...
                var rar2 = new Player2(new Dictionary<string, Animation>()
                     {
                           ...
                           { "Dead", new Animation(_content.Load<Texture2D>("Heroes/Rar/Dead"), 1) },
                           { "Suicide", new Animation(_content.Load<Texture2D>("Heroes/Rar/Suicide"), 4) { FrameSpeed = 1f, }},
                           { "ULTA", new Animation(_content.Load<Texture2D>("Heroes/Rar/ULTAL"), 1) },
                     })
                {
                    Position = new Vector2(1600, 610),
                    Bullet = bulletPrefab,
                ...
                if (HeroState.player1 == 1 && Hero2State.player2 == 1)
                {
                    _sprites = new List<Sprite>()
                   {
                    ...
                    _enemys = _sprites.Where(c2 => c2 is Player2).Select(c2 => (Player2)c2).ToList();
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            if (timerReload2 < 0f && Player2.Reload == 2)
            {
                spriteBatch.Begin();
                spriteBatch.DrawString(_font, "Перезарядка: " + Math.Round(timerReload2, 1), new Vector2(1230f, 200), Color.White);
                spriteBatch.End();
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            timerReload2 += (float)gameTime.ElapsedGameTime.TotalSeconds;
            ...
            if (Player.soundS2 == 2) //Suicide SOUND
            {
                timerSound = 0;
                Player.soundS2 = 22;
            }

            if (Player.soundS2 == 22 && Keyboard.GetState().IsKeyUp(Keys.NumPad1)) //Suicide SOUND
            {
                SoundEffectInstance soundEffectInstance = suicideS.CreateInstance();
                SoundEffect.MasterVolume = 1f;
                soundEffectInstance.IsLooped = false;
            ...
            if (Player.pain == 4 || Player.pain == 3) //Win
            {
